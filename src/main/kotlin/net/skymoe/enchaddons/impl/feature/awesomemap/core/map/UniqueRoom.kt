...
class UniqueRoom(
    ...
    fun getNamePosition(): Pair<Int, Int> = if (AwesomeMap.config.mapCenterRoomName) center else topLeft

    fun getCheckmarkPosition(): Pair<Int, Int> = if (AwesomeMap.config.mapCenterCheckmark) center else topLeft
}
