...
import net.skymoe.enchaddons.impl.feature.awesomemap.utils.RenderUtilsGL.bind
...
object SimpleFontRenderer : IResourceManagerReloadListener {
    ...
    private fun readFontTexture() {
        ...
        charIndex@ for (charIndex in 0..255) {
            ...
            for (scanX in charWidth - 1 downTo 0) {
                ...
                if (found) {
                    SimpleFontRenderer.charWidth[charIndex] = (0.5 + (scanX + 1) * scale).toInt() + 1
                    continue@charIndex
                }
            }
            SimpleFontRenderer.charWidth[charIndex] = (0.5 + scale).toInt() + 1
        }
    ...
    private fun renderChar(ch: Char): Int {
        ...
        return if (i != -1) renderDefaultChar(i) else 0
    }
