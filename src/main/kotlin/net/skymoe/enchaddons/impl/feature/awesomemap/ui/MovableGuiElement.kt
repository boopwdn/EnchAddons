    ...
    fun cornerDrag(
        ...
        when (corner) {
            CornerButton.Corner.TOP_LEFT -> {
                var s =
                    max((x2 - mouseX) / w.toFloat(), (y2 - mouseY) / h.toFloat())
            ...
            CornerButton.Corner.TOP_RIGHT -> {
                var s =
                    max((mouseX - x) / w.toFloat(), (y2 - mouseY) / h.toFloat())
            ...
            CornerButton.Corner.BOTTOM_LEFT -> {
                var s =
                    max((x2 - mouseX) / w.toFloat(), (mouseY - y) / h.toFloat())
            ...
            CornerButton.Corner.BOTTOM_RIGHT -> {
                var s =
                    max((mouseX - x) / w.toFloat(), (mouseY - y) / h.toFloat())
